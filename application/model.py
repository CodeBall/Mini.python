...
class Area(Base):
    ...
    @staticmethod
    def get_area_topic(tpc_area):
        return session.query(Area).filter_by(area_id=tpc_area).first()
...
class Node(Base):
    ...
    @staticmethod
    def get_node_topic(tpc_pid):
        return session.query(Node).filter_by(node_id=tpc_pid).first()
...
class Reply(Base):
    ...
    @staticmethod
    def get_reply_topic(tpc_id):
        return session.query(Reply).filter_by(rpl_tpc_id=tpc_id).all()
...
class Topic(Base):
    ...
    @staticmethod
    def get_topic(id):
        return session.query(Topic).filter_by(tpc_pid=id).all()


    @staticmethod
    def get_topic_area(area_id):
        return session.query(Topic).filter_by(tpc_area=area_id).all()

    @staticmethod
    def get_topic_selt(tpc_id):
        return session.query(Topic).filter_by(tpc_id=tpc_id).first()

    def get_topic_user(user_id):
        return session.query(Topic).filter_by(tpc_uid=user_id).all()
...
class User(Base):
    ...
    @staticmethod
    def get_topic_user(tpc_uid):
        return session.query(User).filter_by(usr_id=tpc_uid).first()
